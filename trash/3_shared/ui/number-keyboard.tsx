...
const NumberKeypad = forwardRef<HTMLInputElement, NumberKeypadProps>(
  (
    ...
    return (
      <div className={cn("flex flex-col gap-3", className)}>
        ...
        {/* Клавиатура */}
        <div className="flex items-center justify-center mx-auto bg-foreground/10 p-10 rounded-4xl">
